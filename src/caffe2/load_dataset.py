...
net_proto.TensorProtosDBInput([dbreader], ["X", "Y"], batch_size_train=16)

print("The net looks like this:")
print(str(net_proto.Proto()))

# no real data until here
